	...
	<div class="container" style="width:40%; text-align:center; margin-top:100px;">
		<form action="../KnjigaServlet" method = "post">
			...
			<div class="form-group row">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" name="name" placeholder="Naslov knjige">
			    </div>
		  	</div>
		    ...
		    <div class="form-group row">
			    ...
			    <div class="col-sm-10">
			      <input type="date" class="form-control" name="published_at" placeholder="Datum publikacije">
			    </div>
		  	</div>
		  	...
		  	<div class="form-group row">
			    ...
			    <div class="col-sm-10">
			      <input type="number" class="form-control" name="available" placeholder="Dostupno primeraka">
			    </div>
		  	</div>
			...
			<button class="btn btn-dark" type="submit">Izmeni informacije o knjizi</button>
		</form>
	</div>
</body>
</html>