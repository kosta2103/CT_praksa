...
<html>
	...
	<body>
			...
			<div class="container" style="width:40%; text-align:center; margin-top:100px;">
				<form action="/Library/KnjigaServlet" method = "get" id="form">
				
					<div class="form-group" style="display: flex;">
		      			<input class="form-control mr-sm-2" type="search" placeholder="Unesite naslov knjige ili ime autora" aria-label="Search" name="search">
		      			<input type="hidden" name="hidden" value="search">
		      			<button type="submit" class="btn btn-dark">PRETRAZIVANJE</button>
		      		</div>
				...
				<table class="table" style="margin-top: 20px;"> 
					...
					<tbody>
						<%
							if(request.getAttribute("searched_data") != null)
							{
								ResultSet rs = (ResultSet) request.getAttribute("searched_data");
