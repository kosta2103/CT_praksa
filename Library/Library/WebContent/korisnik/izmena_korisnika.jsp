		...
		<form action="../KorisnikServlet" method = "post">
		    ...
		    <div class="form-group row">
		  	...
		  	<div class="form-group row">
			    ...
			    <div class="col-sm-10">
			      <input type="number" class="form-control" name="user_id" placeholder="Broj clanske karte" required>
			    </div>
		  	</div>

			<input type="hidden" name="hidden" value="update">
			<button class="btn btn-dark" type="submit">Izmeni informacije o korisniku</button>
		</form>
	</div>
</body>
</html>